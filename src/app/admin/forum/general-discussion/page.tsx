...
import { MessagesSquare, Trash2, Eye, CalendarDays, User as UserIcon, MessageCircle as ReplyIcon, Search, ListFilter, XCircle } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center text-3xl font-headline text-primary"><MessagesSquare className="mr-3 h-8 w-8 animate-pulse" /> Manage General Discussion</CardTitle>
  ...
  return (
    <Card className="shadow-lg border-border">
      <CardHeader>
        ...
        <CardDescription>Oversee and manage topics and posts within the General Discussion forum category.</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        {filteredAndSortedTopics.length > 0 ? (
          ...
          <p className="text-muted-foreground text-center py-10">
             {searchTerm ? `No topics match your search for "${searchTerm}".` : "No topics found in General Discussion."}
          </p>
        )}
      </CardContent>
